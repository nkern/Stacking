...
axes.set_title('Self Stacked Ensemble Mass Scatter (2124 Halos) 12/5/13')
...
axes.set_title('Self Stacked Ensemble Mass Bias (2124 Halos) 12/5/13')
...
## LOS MASS SCATTER
fig,axes = mp.subplots(1,1)
p1, = axes.plot(GAL_NUM[0],LOS_MSCAT[0],c='DarkBlue',marker='o',alpha=.7)
axes.plot(GAL_NUM[0],LOS_MSCAT[0],'DarkBlue',alpha=.7)
p2, = axes.plot(GAL_NUM[1],LOS_MSCAT[1],c='DarkGreen',marker='o',alpha=.7)
axes.plot(GAL_NUM[1],LOS_MSCAT[1],'DarkGreen',alpha=.7)
p3, = axes.plot(GAL_NUM[2],LOS_MSCAT[2],c='FireBrick',marker='o',alpha=.7)
axes.plot(GAL_NUM[2],LOS_MSCAT[2],'FireBrick',alpha=.7)
p4, = axes.plot(GAL_NUM[3],LOS_MSCAT[3],c='Indigo',marker='o',alpha=.7)
axes.plot(GAL_NUM[3],LOS_MSCAT[3],'Indigo',alpha=.7)
p5, = axes.plot(GAL_NUM[4],LOS_MSCAT[4],c='DarkSlateGrey',marker='o',alpha=.7)
axes.plot(GAL_NUM[4],LOS_MSCAT[4],'DarkSlateGrey',alpha=.7)
p6, = axes.plot(IND_RICH,IND_MSCAT,'ko',ms=8,alpha=.8)
axes.plot(IND_RICH,IND_MSCAT,'k',lw=3,alpha=.4)
axes.set_xlabel('Line of Sight Sampling Richness',fontsize=14)
axes.set_ylabel('Mass Estimate Scatter',fontsize=14)
axes.set_title('Averaged Systems Mass Scatter (2124 Halos) 12/5/13')
axes.legend([p1,p2,p3,p4,p5,p6],["N=5, 2<LOS<100","N=10, 2<LOS<100","N=15, 2<LOS<100","N=25, 2<LOS<100","N=50, 2<LOS<100","Gifford 2013"],loc=1)
axes.set_xlim(0,52)
...
## LOS MASS BIAS
fig,axes = mp.subplots(1,1)
p6 = axes.errorbar(IND_RICH,IND_MBIAS,yerr=IND_MBIAS_ERR,lw=2,c='k',alpha=.6)
p1, = axes.plot(GAL_NUM[0],LOS_MBIAS[0],c='DarkBlue',marker='o',alpha=.8)
axes.plot(GAL_NUM[0],LOS_MBIAS[0],'DarkBlue',alpha=.7)
p2, = axes.plot(GAL_NUM[1],LOS_MBIAS[1],c='DarkGreen',marker='o',alpha=.8)
axes.plot(GAL_NUM[1],LOS_MBIAS[1],'DarkGreen',alpha=.7)
p3, = axes.plot(GAL_NUM[2],LOS_MBIAS[2],c='FireBrick',marker='o',alpha=.8)
axes.plot(GAL_NUM[2],LOS_MBIAS[2],'FireBrick',alpha=.7)
p4, = axes.plot(GAL_NUM[3],LOS_MBIAS[3],c='Indigo',marker='o',alpha=.8)
axes.plot(GAL_NUM[3],LOS_MBIAS[3],'Indigo',alpha=.7)
p5, = axes.plot(GAL_NUM[4],LOS_MBIAS[4],c='DarkSlateGrey',marker='o',alpha=.8)
axes.plot(GAL_NUM[4],LOS_MBIAS[4],'DarkSlateGrey',alpha=.7)
axes.set_xlabel('Line of Sight Sampling Richness',fontsize=14)
axes.set_ylabel('Mass Estimate Bias',fontsize=14)
axes.set_title('Averaged Systems Mass Bias (2124 Halos) 12/5/13')
axes.legend([p1,p2,p3,p4,p5,p6],["N=5, 2<LOS<100","N=10, 2<LOS<100","N=15, 2<LOS<100","N=25, 2<LOS<100","N=50, 2<LOS<100","Gifford 2013"],loc=7)
axes.set_xlim(0,160)
axes.set_ylim(-1.,.1)
axes.locator_params(axis='both',nbins=12)
