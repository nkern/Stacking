...
do
	...
	sed -e ":@@write_loc@@:$_write_loc:g;s:@@data_loc@@:$_data_loc:g;s:@@job_array@@:$_job_array:g;s:@@clus_num@@:$_clus_num:g;s:@@gal_num@@:$_gal_num:g;s:@@line_num@@:$_line_num:g;s:@@method_num@@:$_method_num:g;s:@@cell_num@@:$_cell_num:g;s:@@table_num@@:$table_num:g;s:@@run_los@@:0:g" < table_flux_stack_pbs_rerun.sh > $_data_loc/$_write_loc/script_rerun.sh

	# Change run_los = True if line_num == 100
	let "a=${cell_num[$k]}%7"
	if [ $a == 0 ]
		then
		sed -e "s:@@write_loc@@:$_write_loc:g;s:@@data_loc@@:$_data_loc:g;s:@@job_array@@:$_job_array:g;s:@@clus_num@@:$_clus_num:g;s:@@gal_num@@:$_gal_num:g;s:@@line_num@@:$_line_num:g;s:@@method_num@@:$_method_num:g;s:@@cell_num@@:$_cell_num:g;s:@@table_num@@:$table_num:g;s:@@run_los@@:1:g" < table_flux_stack_pbs_rerun.sh > $_data_loc/$_write_loc/script_rerun.sh
